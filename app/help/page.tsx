...
import { ArrowLeft, Book, Info, FileText, Scale, Menu, X, ChevronRight, Printer, Megaphone, HelpCircle, Settings, Plus, Download, Upload, Github } from 'lucide-react'
          ...
          <div className="space-y-8 animate-fadeIn">
              ...
              <ul className="space-y-3">
                {t.help.guide.addFlight.steps.map((step: string, index: number) => (
                  <li key={index} className="flex items-start gap-3 text-gray-700 dark:text-gray-300">
                    <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 text-xs font-bold mt-0.5">
                      {index + 1}
                    </span>
                    <span>{step}</span>
                  </li>
            ...
            <section className="space-y-4">
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                      ...
                      <th scope="col" className="px-6 py-3">Accepted Headers</th>
                      <th scope="col" className="px-6 py-3">Description</th>
                    </tr>
                  </thead>
                  <tbody>
                    {t.help.guide.csv.fields.map((field: any, index: number) => (
              ...
              <div className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
                <p className="text-xs text-gray-400 mb-2 uppercase font-bold">Example CSV Content:</p>
                <pre className="font-mono text-sm whitespace-pre">{t.help.guide.csv.example}</pre>
              </div>
            </section>
          </div>
        )
        ...
        return (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="grid gap-4">
              {Object.entries(t.help.fields).map(([key, value]) => {
        ...
        return (
          <div className="space-y-8 animate-fadeIn">
            ...
            <div className="space-y-8">
              {t.help.easa.regulations.map((reg: any, index: number) => (
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="bg-white/50 dark:bg-gray-800/50 p-8 rounded-2xl border border-gray-200 dark:border-gray-700 text-center space-y-6">
              <div className="flex justify-center">
                <img src="/favicon.ico" alt="SimpleLogbook Logo" className="w-20 h-20 rounded-xl shadow-lg" />
              </div>
              
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">SimpleLogbook</h3>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col md:flex-row">
      ...
      <div className="md:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4 flex items-center justify-between sticky top-0 z-20">
        <div className="flex items-center gap-3">
          <Link href="/" className="p-2 -ml-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
            <ArrowLeft size={20} />
          </Link>
      ...
      `}>
        <div className="p-6">
          <div className="hidden md:flex items-center gap-3 mb-8">
            <Link href="/" className="p-2 -ml-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">
              <ArrowLeft size={20} />
            </Link>
